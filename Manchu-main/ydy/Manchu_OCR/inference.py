...
parser.add_argument('--img_path', type=str, default=r'D:\data\pycharmProgram\Manchu\Manchu_OCR\examples\zhungeer.png', help='the path of the input image to network')
...
parser.add_argument('--encoder', type=str, default=r'D:\data\pycharmProgram\ManchuOCR\model\encoder_1.pth', help="path to encoder (to continue training)")
parser.add_argument('--decoder', type=str, default=r'D:\data\pycharmProgram\ManchuOCR\model\decoder_1.pth', help='path to decoder (to continue training)')
